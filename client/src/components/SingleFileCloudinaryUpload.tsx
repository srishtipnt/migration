        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p>
                Files are stored securely in Cloudinary cloud storage and metadata is saved in MongoDB.
                This provides fast access, automatic optimization, and reliable backup.
              </p>
            </div>
          </div>
        </div>
